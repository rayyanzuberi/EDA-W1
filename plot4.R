...
#top right
with(hpc0102, plot(datetime, Voltage, type='l', xlab='datetime', ylab='Voltage'))

#bottom right
with(hpc0102, plot(datetime, Sub_metering_1, ylab = 'Energy sub metering', type='n'))
with(hpc0102, lines(datetime, Sub_metering_1, col='black'))
with(hpc0102, lines(datetime, Sub_metering_2, col='red'))
with(hpc0102, lines(datetime, Sub_metering_3, col='blue'))

#bottom left
with(hpc0102, plot(datetime, Global_reactive_power, type='l', xlab='datetime', ylab='Global_reactive_power'))
#close device
dev.off()